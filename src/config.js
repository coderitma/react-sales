const config = {
  API_BASE_URL: "http://localhost:3001", // ketika proxy diaktifkan untuk menangani cors, setup self host di sini.
  BASE_URL: "http://localhost:3001", // ketika proxy diaktifkan untuk menangani cors, setup self host di sini.
